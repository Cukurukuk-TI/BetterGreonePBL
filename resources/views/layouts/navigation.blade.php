<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="#" :active="false">{{ __('Produk') }}</x-responsive-nav-link>
            <x-responsive-nav-link href="#" :active="false">{{ __('Artikel') }}</x-responsive-nav-link>
            <x-responsive-nav-link href="#" :active="false">{{ __('Kontak') }}</x-responsive-nav-link>
            <x-responsive-nav-link href="#" :active="false">{{ __('Tentang Saya') }}</x-responsive-nav-link>
        </div>
